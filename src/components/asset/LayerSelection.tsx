...
import { layerConfig, mvpLayerCodes, generateHumanFriendlyName, generateMachineFriendlyAddress, getNextSequentialNumber } from '../../api/layerConfig';
  ...
  useEffect(() => {
    const fetchLayers = async () => {
      try {
        ...
        const filteredLayers = allLayerOptions.filter(layer => 
